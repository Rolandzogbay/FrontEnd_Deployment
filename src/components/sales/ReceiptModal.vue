<template>
  ...
  >
    <div class="w-full max-w-5xl h-[94vh] overflow-hidden rounded-[24px] sm:rounded-[30px] bg-white shadow-2xl flex flex-col">
      <!-- Header -->
      ...
      <div id="receipt-print-area" class="flex-1 overflow-y-auto p-4 sm:p-5 md:p-6 bg-slate-50">
        <div class="mx-auto max-w-4xl rounded-[24px] sm:rounded-[30px] border border-slate-200 bg-white shadow-sm overflow-hidden">
          <!-- Top -->
          <div class="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-5 sm:px-6 md:px-8 py-6 sm:py-8 text-white">
          ...
          <div class="px-4 sm:px-6 md:px-8 py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p class="text-sm text-slate-500 mt-1">
                  {{ getCustomerEmail(receiptData.sale) }}
                </p>
                <p class="text-sm text-slate-500">
                  {{ getCustomerPhone(receiptData.sale) }}
                </p>
              </div>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
              ...
              <div class="rounded-3xl border border-slate-200 bg-slate-50 p-5 space-y-3">
                ...
                <div class="border-t border-slate-200 pt-3 flex items-center justify-between text-xl font-bold text-slate-900">
      ...
      <!-- Footer -->
      <div class="flex flex-col sm:flex-row justify-end gap-3 border-t border-slate-100 bg-slate-50 px-4 sm:px-5 md:px-6 py-4">
        <button
          @click="$emit('close')"
        ...
        <button
          @click="$emit('print', receiptData.sale, receiptData)"
